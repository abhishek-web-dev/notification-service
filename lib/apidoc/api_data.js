define({ "api": [
  ...
  },
  {
    "group": "NOTIFICATION",
    "version": "1.0.0",
    "description": "<p>API to send ad hoc notification for whatsapp, sms, slack.</p>",
    "type": "post",
    "url": "/notification/",
    "title": "send ad hoc notification",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "gender",
            "description": "<p>Send user gender as a body parameter</p>"
          }
        ]
      }
    },
    ...
    "filename": "app/modules/notification/route.js",
